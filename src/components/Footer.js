                                ...
                                <div className="col-sm-12">
                                    <div className="d-sm-flex justify-content-between align-items-center">
                                        <div className="fs-14 font-weight-600">
                                            © 2020  <a href="/" target="_blank" className="text-white"> indonews </a> . All rights are reserved.
                    </div>
                                        <div className="fs-14 font-weight-600">
                                            Handcrafted by <a href="http://www.softtrine.com/" target="_blank" className="text-white">SoftTrine</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
